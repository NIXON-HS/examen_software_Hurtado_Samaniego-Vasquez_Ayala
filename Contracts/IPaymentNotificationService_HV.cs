...
namespace examen_software_Hurtado_Samaniego_Vasquez_Ayala.Contracts
{
    ...
    /// </summary>
    public interface IPaymentNotificationService_HV
    {
        NotificationResult_HV[] NotifyPaymentResult_HV(PaymentResult_HV paymentResult_HV, RecipientInfo_HV recipient_HV);
    }
}
